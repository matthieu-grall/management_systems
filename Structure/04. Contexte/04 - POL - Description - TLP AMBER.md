# Système de management - Description
...
[05. Leadership](#05-leadership)<br>
...
Chaque répertoire comprend des sous-répertoires :
- _Enregistrements, pour archiver les fichiers dont on a besoin de conserver une trace, et
- _Poubelle, pour retrouver facilement des fichiers devenus obsolètes sans les supprimer complètement.

## Documents de référence

### Références externes

Les documents suivants sont cités dans le système de management par leur libellé court :

| <center>**Libellé court**</center> | <center>**Description**</center> |
| --- | --- |
| [Bons réflexes] | _Les bons réflexes en cas d'intrusion sur un système d'information_, CERT-FR [↗](https://www.cert.ssi.gouv.fr/les-bons-reflexes-en-cas-dintrusion-sur-un-systeme-dinformation/) |
| [Directives de l'ISO] | _Harmonized approach for management system standards - Harmonized structure for MSS with guidance for use (Directives / Annex SL / Appendix 2)_, Organisation internationale de normalisation (ISO, 2024) [↗](https://www.iso.org/sites/directives/current/consolidated/index.html#_Toc165305046) |
| [Guide de remédiation] | _Cyberattaques et remédiation - Piloter la remédiation_, Agence nationale de la sécurité des systèmes d’information (ANSSI, 2023) [↗](https://cyber.gouv.fr/sites/default/files/document/20231218_Volet_operationnel_cyberattaquesetremediation_a5_v1j.pdf) |
| [ISO/IEC 27001] | _Sécurité de l'information, cybersécurité et protection de la vie privée — Systèmes de management de la sécurité de l'information — Exigences_ (2022) et Amendement 1 (2024), Organisation internationale de normalisation (ISO) [↗](https://www.iso.org/fr/standard/27001)<br>(disponible dans  07. Gestion/Références/) |
| [ISO/IEC 27002] | _Sécurité de l'information, cybersécurité et protection de la vie privée — Systèmes de management de la sécurité de l'information — Mesures de sécurité de l'information_ (2022), Organisation internationale de normalisation (ISO) [↗](https://www.iso.org/fr/standard/75652.html)<br>(disponible dans 07. Gestion/Références/) |
| [ISO/IEC 27701] | _Techniques de sécurité — Extension d'ISO/IEC 27001 et ISO/IEC 27002 au management de la protection de la vie privée — Exigences et lignes directrices_, Organisation internationale de normalisation (ISO, 2019) [↗](https://www.iso.org/fr/standard/71670.html)<br>(disponible dans  07. Gestion/Références/) |
| [RGPD] | Règlement (UE) 2016/679 du Parlement européen et du Conseil du 27 avril 2016, relatif à la protection des personnes physiques à l’égard du traitement des données à caractère personnel et à la libre circulation de ces données (RGPD) [↗](https://eur-lex.europa.eu/eli/reg/2016/679/oj?locale=fr) |

### Références composant le système de management

Les documents suivants sont cités dans le système de management par leur libellé court :

| <center>**Libellé court**</center> | <center>**Section**</center> | <center>**Type**</center> | <center>**Description**</center> |
| --- | --- | --- | --- |
| [Description] | 04 | POL | Description du système de management et règles de gestion classées par sections de l’[ISO/IEC 27001]<br>
| [Pilotage] | 05 | ENR | Tableur de pilotage du système de management (comprend le suivi des actions et des indicateurs) |
| [Engagement de la direction] | 05 | POL | Engagement de la direction de l’organisme (comprend ses objectifs en matière de sécurité de l’information) |
| [Politique générale] | 05 | POL | Règles applicables en matière de sécurité de l’information, classées par sections de l’[ISO/IEC 27002] |
| [Gérer les risques] | 06 | PRO | Méthode de gestion des risques de l’organisation |
| [Déclaration d’applicabilité] | 06 | POL | Déclaration d’applicabilité des bonnes pratiques de sécurité de l’information |
| [Étude des risques] | 08 | ENR | Étude des risques liés au domaine d’application du système de management, menée conformément à la procédure [Gérer les risques] (comprend la liste des fournisseurs) |
| [Clauses types] | 08/ORGA | POL | Clauses types pour les contrats |
| [Gérer les fournisseurs] | 08/ORGA | PRO | Procédure de gestion des fournisseurs et sous-traitances |
| [Intégrer la sécurité dans les projets] | 08/ORGA | PRO | Les mesures spécifiques pour le cycle de développement |
| [Inventaire des données] | 08/ORGA | ENR | Liste des accès, liste des identifiants des collaborateurs, forme des identifiants |
| [Plan de continuité] | 08/ORGA | PRO | Procédure de reprise des activités en cas sinistre |
| [PAS type] | 08/ORGA | POL | Plan d'assurance sécurité (PAS) qui formalise les règles relatives au sujet du système de management que les fournisseurs de services ou de solutions s'engagent à respecter |
| [Charte numérique] | 08/PERS | POL | Charte numérique de l’organisation |
| [Gérer les arrivées] | 08/PERS | PRO | Pendant l’arrivée de collaborateurs |
| [Gérer ls départs] | 08/PERS | PRO | Procédure appliquée au départ de collaborateurs |
| [Plan de reprise] | 08/TECH | PRO | Procédure de reprise des outils informatiques en cas sinistre |
...
Il est **piloté à l’aide d’un outil de [Pilotage] dédié**, qui :
...
<u>Observables</u> : la présente [Description], [Engagement de la direction], [Pilotage], et enregistrements liés au leadership.
...
- les noms de fichiers datés correspondent à des « enregistrements » ;
